...
from greens import G_spec, G_spec_Kummar
...
# test derivative
z_p = -2 * pi * np.cos(x_axis * 2 * pi / L) / L
n = np.array([np.ones_like(z_p), -z_p])
test_n = G_spec(kc * L, alpha_0 * L, r_axis / L, 10000, n=n)
1/0
